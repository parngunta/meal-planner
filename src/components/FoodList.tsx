...
function SortableFoodCard({ food, onDelete, onEdit }: { food: Food; onDelete: (id: string) => void; onEdit: (food: Food) => void }) {
  ...
  if (editing) {
    return (
      <div className="swipe-wrapper" ref={setNodeRef} style={style}>
  ...
  return (
    <div className="swipe-wrapper" ref={setNodeRef} style={style}>
      <div
        ...
        style={{ transform: `translateX(${swipeX}px)`, transition: isSwipingActive ? 'none' : 'transform 0.2s ease' }}
        ...
        <div className="food-card">
          <div className="food-card-header">
            ...
            <div className="food-card-header-actions">
              ...
              <button className="btn-icon desktop-delete" onClick={handleClickDelete} title="Delete">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button className="swipe-delete" onClick={handleClickDelete} aria-label="Delete">
