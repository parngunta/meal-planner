  ...
  return (
    <div className="food-picker">
      <div className="picker-card">
        <div className="picker-card-display">
          {phase === 'idle' && (
            <div className="pick-idle">
              <span className="pick-idle-emoji">{MEAL_EMOJIS[selectedMeal]}</span>
              <h3 className="pick-idle-title">What's for {MEAL_LABELS[selectedMeal]}?</h3>
              <p className="pick-idle-sub">Tap the button to pick a meal</p>
            </div>
          )}
